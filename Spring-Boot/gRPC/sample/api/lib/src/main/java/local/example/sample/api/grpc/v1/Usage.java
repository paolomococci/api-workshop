...
/**
 * Protobuf enum {@code local.example.sample.api.grpc.v1.Usage}
 */
public enum Usage
   ...
   * <code>SINGLE_USE = 1;</code>
   */
  public static final int SINGLE_USE_VALUE = 1;
  ...
  public static final com.google.protobuf.Descriptors.EnumDescriptor
      getDescriptor() {
    return local.example.sample.api.grpc.v1.PaymentGatewayService.getDescriptor().getEnumTypes().get(1);
  }
  ...
  // @@protoc_insertion_point(enum_scope:local.example.sample.api.grpc.v1.Usage)
}
